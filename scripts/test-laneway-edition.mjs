...
assert.match(css,/\[data-edition-type="laneway"\] \.edition-brand-logo\{/);
assert.doesNotMatch(css,/\[data-edition-type="laneway"\] \.edition-brand-logo\{[^}]*(?:filter|mix-blend-mode)/);
assert.ok(html.includes('class="laneway-result-logo" src="/assets/laneway-music-logo-reverse-transparent.png"'));
assert.doesNotMatch(html,/class="laneway-result-logo"[^>]+laneway-music-logo-source\.jpg/);
assert.doesNotMatch(css,/\[data-edition-type="laneway"\] \.laneway-result-logo\{[^}]*(?:filter|mix-blend-mode)/);
...
assert.match(factory,/logoArtwork:'assets\/laneway-music-logo-reverse-transparent\.png'/);
...
await fs.access('assets/laneway-music-logo-reverse-transparent.png');

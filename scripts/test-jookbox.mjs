...
assert.match(html, /styles\.css\?v=20260801-bar-jookbox-7/);
assert.match(html, /app\.js\?v=20260801-bar-jookbox-7/);
...
assert.match(app, /const VERSION="20260801-bar-jookbox-7"/);

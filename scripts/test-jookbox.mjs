...
assert.match(html, /styles\.css\?v=20260731-bar-jookbox-4/);
assert.match(html, /app\.js\?v=20260731-bar-jookbox-4/);
...
assert.match(app, /const VERSION="20260731-bar-jookbox-4"/);

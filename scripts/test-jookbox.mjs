...
assert.match(html, /styles\.css\?v=20260802-bar-heritage-2/);
assert.match(html, /app\.js\?v=20260802-bar-heritage-2/);
...
assert.match(app, /const VERSION="20260802-bar-heritage-2"/);

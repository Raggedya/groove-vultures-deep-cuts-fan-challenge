...
assert.match(html, /styles\.css\?v=20260802-bar-heritage-4/);
assert.match(html, /app\.js\?v=20260802-bar-heritage-4/);
...
assert.match(app, /const VERSION="20260802-bar-heritage-4"/);

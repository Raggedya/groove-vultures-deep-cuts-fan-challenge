...
const LOCKED_COIN_SHA="0d5af258fc72136626d4888c3b6a75240afe8d7b6c00d5837576b92c4ebadec0";
...
export function publicationReadiness(venue,{videoPath="",videoSizeBytes=venue?.admin?.customVideo?.sizeBytes||0}={}){
  ...
  if(destinations.length!==5)errors.push("Exactly five labelled HTTPS destinations are required.");

...
function renderBarStudioShareHand(side){
  return`<svg class="share-hand share-hand-${side}" viewBox="0 0 180 72" aria-hidden="true"><path class="share-hand-ink" d="M4 17h34v38H4z M38 22h11c8 0 14 3 21 8l8 6h16l-8-8c-4-4-4-10 0-13 4-4 10-3 14 1l16 15h47c8 0 13 4 13 10 0 7-5 11-13 11h-58l-15 9c-7 4-14 6-23 6H38z"/><path d="M11 24h19M11 31h19M11 38h19M11 45h19M101 38h61"/></svg>`;
}
...
<head>
  ...
  <style>
    *{box-sizing:border-box}[hidden]{display:none!important}html{background:#050201}body{margin:0;min-height:100vh;background:#050201;color:#fff;font-family:Arial,Helvetica,sans-serif}
    ...
    .title{position:absolute;z-index:3;top:6.15%;left:14%;width:72%;height:12.7%;overflow:visible;color:#d8b36c;filter:brightness(.82) saturate(.78);transition:filter .45s}.machine.is-neon-on .title{filter:brightness(1.04) saturate(.92)}.title h1{position:absolute;width:1px;height:1px;padding:0;overflow:hidden;clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap}.title svg{display:block;width:100%;height:100%;overflow:visible}.title-curve{fill:#d7b77b;stroke:rgba(45,23,9,.76);stroke-width:1.15;paint-order:stroke fill;font:800 76px/1 Georgia,serif;letter-spacing:.045em;filter:drop-shadow(0 2px 0 #271206) drop-shadow(0 0 3px rgba(255,225,164,.3))}.title-model{fill:#d4b272;stroke:rgba(45,23,9,.68);stroke-width:.7;paint-order:stroke fill;font:800 26px/1 Georgia,serif;letter-spacing:5.5px;filter:drop-shadow(0 1px 0 #2b1508)}.title-ornament{fill:none;stroke:#aa8049;stroke-width:1.7;stroke-linecap:round;stroke-linejoin:round;opacity:.86;filter:drop-shadow(0 1px 0 #251006)}
    ...
    .keys{position:absolute;z-index:4;top:66.15%;left:11.85%;width:76.85%;height:21.05%;display:grid;grid-template-columns:repeat(3,1fr);grid-template-rows:repeat(2,1fr);gap:4.35% 2.15%}.key{min-width:0;display:grid;grid-template-columns:minmax(0,1fr);grid-template-rows:minmax(0,1fr) auto;align-items:stretch;justify-items:stretch;row-gap:2.5%;padding:7% 5.5% 7.5%;overflow:hidden;border:0;border-radius:4%;background:linear-gradient(180deg,rgba(255,234,181,.012),rgba(90,46,17,.018));color:#2b180c;text-decoration:none;text-align:center;box-shadow:inset 0 1px rgba(255,244,210,.025),inset 0 -3px rgba(55,26,9,.025);filter:brightness(.3) saturate(.34);opacity:.34;pointer-events:none;transition:filter .42s,opacity .42s,box-shadow .42s,background .42s,transform .1s}.key-icon-frame{grid-column:1;grid-row:1;display:grid;width:100%;height:100%;min-height:0;place-items:center}.key-icon{width:min(56%,54px);height:60%;max-width:100%;overflow:visible;color:inherit;filter:drop-shadow(0 1px 0 rgba(255,235,188,.34))}.key-icon g{fill:none;stroke:currentColor;stroke-width:3.6;stroke-linecap:round;stroke-linejoin:round}.key-icon .fill{fill:currentColor;stroke:none}.key strong{grid-column:1;grid-row:2;display:grid;min-height:1.72em;place-items:center;font:800 clamp(9px,2.35vw,12px)/.88 Georgia,serif;letter-spacing:.005em;overflow-wrap:normal;word-break:normal;text-wrap:balance;text-transform:uppercase}.key.is-placeholder{opacity:.18}.machine.is-buttons-on .key:not(.is-placeholder){color:#2a180c;filter:brightness(.98) saturate(.84);opacity:1;pointer-events:auto}.machine.is-buttons-on .key.is-current{color:#211108;background:radial-gradient(ellipse 88% 82% at 50% 44%,rgba(255,252,222,.44),rgba(255,221,145,.15) 57%,transparent 82%);filter:brightness(1.14) saturate(.88);box-shadow:inset 0 0 22px rgba(255,250,218,.62),inset 0 -5px 12px rgba(174,92,29,.18),0 0 9px rgba(255,203,98,.34);animation:keyGlow 1500ms ease-in-out both}.machine.is-buttons-on .key:focus-visible{outline:2px solid #fff1bd;outline-offset:-3px}.machine.is-buttons-on .key:active{transform:translateY(2px)}
    .support{position:absolute;z-index:4;top:87.7%;left:12.05%;width:76.55%;height:7.75%;display:grid;place-content:center;padding:1% 18.5%;overflow:hidden;border:0;border-radius:2%;background:linear-gradient(180deg,rgba(255,240,199,.018),rgba(103,54,21,.025));color:#28160b;font:inherit;text-align:center;box-shadow:inset 0 1px rgba(255,245,215,.045),inset 0 -3px rgba(50,24,8,.045);filter:brightness(.28) saturate(.38);opacity:.48;pointer-events:none;transition:filter .3s,opacity .3s,box-shadow .3s,transform .1s}.share-hand{position:absolute;top:50%;display:block;width:17%;height:auto;overflow:visible;fill:none;stroke:#29170b;stroke-width:2.2;stroke-linecap:round;stroke-linejoin:round;filter:drop-shadow(0 1px rgba(255,239,193,.28));transform-origin:50% 50%}.share-hand .share-hand-ink{fill:#29170b;stroke:none}.share-hand-left{left:2.5%;transform:translateY(-50%)}.share-hand-right{right:2.5%;transform:translateY(-50%) scaleX(-1)}.support strong{display:grid;gap:0;place-items:center;color:#28160b;font:800 clamp(8px,2.45vw,13px)/.86 Georgia,serif;letter-spacing:.015em;text-transform:uppercase;text-wrap:balance}.support strong span:last-child{display:flex;width:100%;align-items:center;justify-content:center;gap:4%;font-size:.72em;line-height:.92;letter-spacing:.045em;white-space:nowrap}.support strong span:last-child:before,.support strong span:last-child:after{width:12%;height:1px;content:"";background:linear-gradient(90deg,transparent,#5e3518)}.support strong span:last-child:after{background:linear-gradient(90deg,#5e3518,transparent)}.machine.is-buttons-on .support{filter:brightness(.98) saturate(.78);opacity:1;pointer-events:auto;cursor:pointer;box-shadow:inset 0 0 14px rgba(255,235,185,.13),inset 0 -3px rgba(66,31,9,.08)}.machine.is-buttons-on .support:focus-visible{outline:2px solid #fff0b0;outline-offset:-4px;filter:brightness(1.08)}.machine.is-buttons-on .support:active{transform:translateY(2px)}
...
<body>
    ...
    <section id="machine" class="machine" aria-label="${escapeAttribute(input.name||"Venue")} Bar Edition preview">
      <div class="title">
        ...
        <svg viewBox="0 0 720 222" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
          <defs><path id="studioBarTitlePath" d="M72 143Q360 55 648 143"/></defs>
  ...
  <script${scriptNonce?` nonce="${escapeAttribute(scriptNonce)}"`:""}>
    ...
    const title=document.getElementById("barTitle"),frame=title?.closest(".title");let pending=0;const fit=()=>{pending=0;const characters=String(title.textContent||"").trim().length;title.removeAttribute("textLength");title.removeAttribute("lengthAdjust");title.style.letterSpacing=characters>19?".018em":characters>14?".03em":".045em";title.style.fontSize="76px";const target=540,measured=Math.max(1,title.getComputedTextLength?.()||target),size=Math.max(31,Math.min(76,76*target/measured));title.style.fontSize=size.toFixed(2)+"px";const finalWidth=Math.max(1,title.getComputedTextLength?.()||target);if(finalWidth>target){title.setAttribute("textLength",String(target));title.setAttribute("lengthAdjust","spacingAndGlyphs")}title.dataset.fittedSize=size.toFixed(2);title.dataset.fittedWidth=Math.min(finalWidth,target).toFixed(2)};const schedule=()=>{cancelAnimationFrame(pending);pending=requestAnimationFrame(fit)};new ResizeObserver(schedule).observe(frame);document.fonts?.ready?.then(schedule).catch(()=>{});schedule()})();
  </script>
</body>
</html>`;
}

...
assert.equal(config.lanewayCompanyChallenge.invitationRevealDelayMs,5000);
...
assert.match(app,/scheduleLanewayCompanyChallengeReveal/);
assert.match(app,/invitationRevealDelayMs/);
...
assert.match(css,/@keyframes lanewayQuizInvitationGlow/);

...
- The physical top marquee is permanently branded `AGGITS`. A project name remains mandatory for library identity, permanent URLs, QR posters, emails and accessibility, but it must never replace or alter the visible `AGGITS` cabinet heading.

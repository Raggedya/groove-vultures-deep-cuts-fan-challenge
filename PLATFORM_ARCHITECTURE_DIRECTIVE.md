...
- From 2026-07-31 onward, the permanent factory default is the owner-approved `atlas-reference-cabinet/1`: a SHA-256-locked 887 × 1774 photoreal black-walnut, chrome and neon cabinet with a live marquee, hero biography ticker, left coin mechanism, privacy-enhanced YouTube screen, three-by-two key bank, prominent `Support Our Band` share action and lower status hardware. This shared core asset is never copied from or made dependent on another edition.

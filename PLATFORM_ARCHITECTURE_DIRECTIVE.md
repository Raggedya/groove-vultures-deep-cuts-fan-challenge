...
- JookBox uses a full-screen photoreal old-school illuminated cabinet with subtly weathered polished wood, aged chrome/gold trim, restrained period lighting and a privacy-enhanced 16:9 featured-video hero. The small `JookBox` model mark remains subordinate to the prominent dynamic band name; the coin and visible slot are mounted above the video, and Share is a cabinet control beside the video metadata rather than a generic bottom-bar action.

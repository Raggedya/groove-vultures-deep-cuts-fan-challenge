...
- [x] Lock the Bar-only heritage mahogany and aged-brass cabinet presentation with a large single-line amber ticker, six parchment destination keys, venue share plate and bottom Clearlight brass copyright plate while preserving the ATLAS Band Edition and all publication behaviour.

...
- [x] Add the isolated static Bar Edition Studio workflow: locked ATLAS cabinet, venue marquee, administrator ticker, local MP4, five labelled HTTPS keys plus Share, drag/click/keyboard coin activation, real coin audio, neon/CRT start-up and automated Apple Silicon/Intel packaging without changing Band Edition.

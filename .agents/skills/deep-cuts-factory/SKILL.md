...
5. Create an `agent/deep-cuts-<slug>` branch and pull request through the connected GitHub app. Mark it ready, wait for green validation, then enable auto-merge. Do not ask the owner to merge or use PowerShell.

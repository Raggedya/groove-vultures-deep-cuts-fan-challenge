...
The standalone `laneway_company` catalogue-discovery engine is not the `Laneway [Band or Artist]` factory output and is not the `indie_wheel` model. Preserve its 35-artist wheel, compact accessible centre-button spiral, rich inline artist card, Surprise Me, explicit cross-catalogue recommendation map, roster-to-card selection, ten-question Laneway artist quiz, quiz-result recommendations and versioned first-party reporting only on `dc_b9e7b66620`. Its restrained black, charcoal, white and red presentation must not reintroduce the retired pale-blue invitation or purchase heartbeat. Never propagate these presentation or data rules to artist-specific Laneway or Cool Death editions.

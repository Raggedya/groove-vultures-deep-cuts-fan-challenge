...
Venue Library may cross that boundary only through **Secure Publish Venue**: one-time owner email activation, a Windows-encrypted device-scoped credential, mandatory validation, versioned Cloudflare asset publication, confirmed email delivery, live page verification, MP4 verification and permanent QR verification. The owner never performs a GitHub or Cloudflare step. Never store a plaintext credential or mark a venue published early. Reject public Bar MP4 assets over 24 MiB and roll back any unverified update.

...
Preserve the isolated ATLAS exception at `dc_e22f1cb651`: `atlas-reference-cabinet/1` uses the locked 887 × 1774 ATLAS artwork and maps live content into its marquee, ticker, coin, video, three-by-two key bank, support panel and status hardware. Render only verified destinations, preserve its two-key-row sequence and never fabricate website or merchandise controls. This is not the JookBox factory default and must never affect the locked Filthy Animals reference.
